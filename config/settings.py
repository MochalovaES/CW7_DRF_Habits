...
SECRET_KEY = 'django-insecure-uapy_-a8x8yz$kltfo8zl^zot))p9xj=dphw#)n_kjdr#=@eso'
...
CELERY_BEAT_SCHEDULE = {
    'check_user_activity': {
        ...
        'schedule': timedelta(minutes=30),  # Расписание выполнения задачи (например, каждые 5 минут)
    },
}
